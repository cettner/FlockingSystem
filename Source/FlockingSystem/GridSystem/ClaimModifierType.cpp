...
void UClaimModifierType::OnModifierApply(AClaimableSquareGameGrid * ParentGrid, FGridTileData TileLocation, AGridClaimingActor * Invoker)
{
	ParentGrid->SetSelectedTile(TileLocation);
}


void UClaimModifierType::OnModiferRemoved(AClaimableSquareGameGrid * ParentGrid, FGridTileData TileLocation, AGridClaimingActor * Invoker)
{
