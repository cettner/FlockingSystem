...
void ARTSCamera::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	//	EnhancedInputComponent->BindAction(ZoomInputAction, ETriggerEvent::Started, this, &ARTSCamera::OnInputStarted);

	//	EnhancedInputComponent->BindAction(ZoomInputAction, ETriggerEvent::Completed, this, &ARTSCamera::OnSetDestinationReleased);
	//	EnhancedInputComponent->BindAction(ZoomInputAction, ETriggerEvent::Canceled, this, &ARTSCamera::OnSetDestinationReleased);
	//}
